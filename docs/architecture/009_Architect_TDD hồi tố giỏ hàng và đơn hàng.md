...
## 2. Nơi ghi lại kỷ luật đi tiếp (research.md Decision 3)
...
## 3. Cách chứng minh "test thất bại khi quy tắc bị gỡ" (research.md Decision 4)
...
Khoảng cách thật sự (lịch sử commit, không phải mã nguồn) và quyết định không `git rebase`, cộng giới
hạn phạm vi đã biết: xem [technical-debt.md](technical-debt.md).
