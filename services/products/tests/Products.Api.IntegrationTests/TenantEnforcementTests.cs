...
{
    /// <summary>
    /// Kiểm tra: lấy `ProductsDbContext` từ DI khi chưa có tenant nào được phân giải thì ném
    ...
    /// nối được database.
    /// Task nguồn: spec 003 (danh tính giả lập và tenant) — T024, US2.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Kiểm tra: gọi thẳng `/products` mà không có `X-Tenant-Id` trả về `500 Internal Server Error`.
