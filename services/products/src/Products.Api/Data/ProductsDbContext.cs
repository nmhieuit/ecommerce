...
/// </summary>
/// <remarks>
/// Deliberately has no entity sets: this feature scaffolds the service shell, and Product plus its
/// catalog/pricing records arrive with the first domain story. The context exists now so the
