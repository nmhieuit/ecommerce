...
public class IndependentTokenValidationTests
{
    ...
    /// <summary>
    /// Kiểm tra: gọi thẳng `Orders.Api` (không qua gateway/BFF) mà không kèm token nào bị chính
    ...
    /// <summary>
    /// Kiểm tra: token hợp lệ bị nối thêm chuỗi rác (làm hỏng chữ ký), gửi thẳng tới `Orders.Api`
