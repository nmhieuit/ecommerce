...
namespace Baskets.Api.Features.HealthCheck;
...
public static class HealthCheckEndpoints
{
    ...
    /// </summary>
    /// <remarks>
    /// Opens a raw connection rather than resolving <see cref="BasketsDbContext"/>, which it used to
        ...
        services.AddHealthChecks()
            .AddSqlServer(
                connectionStringFactory: serviceProvider =>
                    serviceProvider.GetRequiredService<IConfiguration>().GetConnectionString("BasketsDb")
                    ?? string.Empty,
