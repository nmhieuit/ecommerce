...
/// </summary>
/// <remarks>
/// Deliberately has no entity sets: this feature scaffolds the service shell, and Basket plus its
/// line items arrive with the first domain story. The context exists now so the readiness probe
/// can prove real connectivity rather than assert process liveness alone.
