...
public class ReadinessTests
{
    ...
    {
        // A syntactically valid but unreachable connection string — proves readiness fails
        // closed rather than silently reporting healthy (spec Edge Cases). No container
        // needed for this path: there is deliberately nothing to connect to.
