...
- The products, baskets, orders, and parties services already expose the HTTP APIs needed for the BFF to call them; building or changing those underlying service APIs is out of scope here.
